...
// Registers
typedef BYTE Stack;
typedef BYTE Register_X;
typedef BYTE Register_Y;
typedef BYTE Accumulator;
typedef WORD PC; // Program Counter
typedef BYTE PSR; // Process Status Register

typedef BYTE Memory;
typedef BYTE Address;
typedef BYTE Zero_Page;
